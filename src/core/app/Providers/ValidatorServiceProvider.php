...
class ValidatorServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Validator::extend('attribute_name_register', function ($attribute, $value, $parameters, $validator) {
            return Attribute::isValidAttributeNameWithRegister($attribute, $value);
        });

        // 文書の属性のkeyのチェック(登録時以外)
        Validator::extend('attribute_name', function ($attribute, $value, $parameters, $validator) {
